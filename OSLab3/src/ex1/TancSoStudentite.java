...
public class TancSoStudentite {
    ...
    Semaphore changingRoomM;
    Semaphore changingRoomF;
    Semaphore dance;

    public void init() {
        //TODO: da se implementira
        dancingRoom = new Semaphore(3);
        changingRoomM = new Semaphore(10);
        changingRoomF = new Semaphore(10);
        dance = new Semaphore(0);
    }
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            changingRoomM.acquire();
            show.presobleci();
            changingRoomM.release();
            dance.acquire();
            dancingRoom.acquire();
            show.tancuvaj();
            dancingRoom.release();
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            //TODO: da se implementira
            changingRoomF.acquire();
            show.presobleci();
            changingRoomF.release();
            dance.release();
        }
    ...
    public class Show {
        ...
        public void printStatus() {
            if (!hasError) {
                ...
                System.out.println("The process in not synchronized according to the conditions in the task");
                show.printLog();
